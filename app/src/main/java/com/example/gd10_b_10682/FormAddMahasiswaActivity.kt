package com.example.gd10_b_10682
...
import com.example.gd10_b_10682.databinding.ActivityFormAddMahasiswaBinding
...
class FormAddMahasiswaActivity : AppCompatActivity() {
    ...
    fun saveData() {
        with(binding) {
            ...
            RClient.instances.createData(nobp, nama, alamat, prodi, lahir)
